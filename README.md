...
Если во вкладке `devices` его нет, нужно зажать кнопку на устройстве на более чем 5 секунд и разрешить сопряжение в `zigbee2mqtt`. Итак убедились, что устройство в сети, можно переходить к настройкам. Переходим к вкладке `exposes` устройства.
