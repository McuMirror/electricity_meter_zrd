...
[Версия на модуле E180-Z5812SP хранится в отдельной ветке](https://github.com/slacky1965/electricity_meter_zrd/tree/E180-Z5812SP) и больше тоже не поддерживается.
...
* Подключиться к сети или покинуть сеть `Zigbee` - удерживать кнопку более 5 секунд.
* Сделать restart модуля - нажать кнопку 3 раза подряд.
...
В проекте используется модуль от компании Tuya на чипе TLSR8258F1KAT32 - ZTU.

<img src="doc/images/module_ztu.png"/>

Испытывалось все на вот таком dongle от Telink

<img src="doc/images/telink_tlsr8258_dongle.jpg"/>

<img src="doc/images/prototype.jpg"/>
...
* Температура (1)
* Четыре тарифа (4)
* Общая энергия по всем тарифам (1)
...
* Частые постоянный вспышки - модуль пытается подключиться к сети.
...
<img src="doc/electricity_meters/kaskad/kaskad_1_mt.jpg">

Счетчик общается по протоколу [МИРТЕК](doc/electricity_meters/kaskad/Star_104_304_1.20.doc).
...
<img src="doc/electricity_meters/kaskad/kaskad_11_c1.jpg">

Счетчик общается по своему [протоколу](doc/electricity_meters/kaskad/2023.01.12-KASKAD_11.doc).
...
<img src="doc/electricity_meters/mercury/mercury-206.jpg">
...
<img src="doc/electricity_meters/energomera/102m_r5_front.jpg">
...
<img src="doc/electricity_meters/energomera/ce208s53-2.png">
...
<img src="doc/electricity_meters/neva/neva_mt124.jpg">
...
<img src="doc/electricity_meters/neva/124_as_e4p_5_60_2.png">
...
### <a id="nartis-100">Однофазный многотарифный счетчик Нартис-100 (Нартис-И100)</a>

<img src="doc/electricity_meters/nartis/nartis100.jpg">
...
<img src="doc/images/z2m_nartis100.jpg">
...
- 3.0.05
	- Отказ от модуля `E180-Z5812SP` в пользу модуля `ZTU`.
	- Добавлен счетчик Нартис-I100.
- 3.0.06
	- Оптимизирована отправка отчетов по нажатию кнопки на устройстве.
	- Убраны принудительные отчеты делителей и множителей.
